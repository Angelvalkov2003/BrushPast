      ...
      <RevealSection className="border-b border-bp-text/10">
        <div className="mx-auto grid max-w-[1400px] lg:grid-cols-2 lg:items-stretch">
          <div className="flex flex-col justify-center px-4 py-10 md:px-10 md:py-14 lg:py-16">
            ...
            <StoryPanel className="relative mt-8 max-w-lg rotate-[-0.15deg] border border-bp-text/25 p-6 shadow-[6px_6px_0_rgba(191,50,1,0.1)] md:p-8" tint="bg-[#f5f0e8]/88">
              <div
              ...
              />
              <p
                className={`${homeHandClass} relative z-10 text-[1.4rem] leading-snug text-bp-text md:text-[1.6rem]`}
              >
                {quoteBefore}
