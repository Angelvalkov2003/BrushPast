...
import type { ErrolParagraph } from "lib/stories/errol-content";
...
function StoryParagraph({ block }: { block: ErrolParagraph }) {
  if (block.pull) {
    return (
      <blockquote
...
export async function ErrolPage() {
        ...
        <div className="mx-auto grid max-w-[1400px] lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="relative flex items-center justify-center bg-[#ebe3d8] px-4 py-8 md:px-10 lg:py-12">
            <div
              ...
              style={{
                clipPath:
                  "polygon(7% 0%, 100% 2%, 96% 100%, 2% 97%, 0% 70%, 3% 38%)",
              }}
            >
              <Image
                src={heroImage}
