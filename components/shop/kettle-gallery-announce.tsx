    ...
    <TextureSection as="section" texture="secondary" className="px-4 py-14 md:px-10 md:py-20">
      ...
      >
        <PolaroidFrame index={3} className="group-hover:rotate-0">
          ...
          <p className={`${homeHandClass} ${bpWhisperUtility} mt-3 text-center text-lg text-bp-accent`}>
        ...
        <div>
          ...
          <p className={`${homeHandClass} ${bpWhisperUtility} mt-5 text-2xl leading-snug text-bp-text/90 md:text-3xl`}>
            Build your own frame. Hang the story where life happens.
          </p>
          <p className={`${bpSubtitleClass} ${bpSubtitleUtility} mt-5 max-w-md text-base leading-relaxed text-bp-text/75`}>
            {KETTLE_GALLERY.teaser}
          </p>
          <p className="mt-8 text-xl text-bp-accent transition-colors group-hover:text-bp-text">
            {KETTLE_GALLERY.cta} →
          </p>
        </div>
      </Link>
