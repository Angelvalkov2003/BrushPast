    ...
    >
      <div className="mx-auto grid max-w-[1400px] gap-12 md:grid-cols-2 md:items-center md:gap-16">
        <div className={clsx(embedded && "md:order-2")}>
          <p className={`${homeHandClass} ${bpWhisperUtility} text-2xl text-bp-accent md:text-3xl`}>The Archive</p>
          ...
          <p className={`${homeHandClass} ${bpWhisperUtility} mt-4 text-2xl text-bp-text/90 md:text-3xl`}>
        ...
        <PolaroidFrame
          index={0}
          className={clsx("mx-auto w-full max-w-md md:max-w-none", embedded && "md:order-1")}
        >
