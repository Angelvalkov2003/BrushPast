            ...
            <div>
              ...
              <IndexCard className="mt-6 max-w-xl">
                <p className={aboutBodyHandClass}>
                  ...
                  chapters. Through art, writing, photography and design, we help people{" "}
                  <span className="text-bp-accent">rebuild identity</span>, gain confidence and
                  connect with community - while a social enterprise model funds the next
                  opportunity.
                </p>
              </IndexCard>
          ...
          <Reveal delay={REVEAL_STAGGER_MS}>
            <IndexCard className="h-full">
              ...
              <p className={`${aboutBodyHandClass} mt-4`}>
                ...
                - and that belief became <span className="font-bold">Brush Past</span>.
              </p>
            </IndexCard>
          </Reveal>
        </div>
