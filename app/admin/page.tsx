...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="mb-2 text-2xl font-bold text-gray-900 sm:text-3xl">Dashboard</h1>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:mb-8 sm:gap-6 md:grid-cols-3">
        <div className="rounded-lg bg-white p-4 shadow sm:p-6">
          ...
          <p className="mt-2 text-2xl font-bold sm:text-3xl">{stats.totalOrders}</p>
        </div>
        <div className="rounded-lg bg-white p-4 shadow sm:p-6">
          <h3 className="text-sm text-gray-500">Pending payment</h3>
          <p className="mt-2 text-2xl font-bold text-amber-600 sm:text-3xl">{stats.pendingPayment}</p>
        </div>
        <div className="rounded-lg bg-white p-4 shadow sm:p-6">
          <h3 className="text-sm text-gray-500">Revenue (last 7 days)</h3>
          <p className="mt-2 text-2xl font-bold text-green-700 sm:text-3xl">{formatPrice(stats.weekRevenue)}</p>
