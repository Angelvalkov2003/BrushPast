    ...
    >
      ...
      >
        <div className="mx-auto w-full max-w-[1400px] text-center">
          ...
          <h1
            className={`${homeHandClass} mt-3 text-[clamp(2.25rem,6vw,4rem)] font-bold leading-tight text-bp-text`}
          >
            This page could not be found.
          </h1>
          <p className={`${homeSerifClass} mx-auto mt-5 max-w-lg text-lg italic text-bp-text/80 md:text-xl`}>
