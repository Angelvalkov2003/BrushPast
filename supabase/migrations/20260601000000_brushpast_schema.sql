-- =============================================================================
-- BrushPast — single schema migration (drops legacy + creates full schema + RLS)
-- =============================================================================
-- Run once in Supabase Dashboard → SQL Editor (or: supabase db push)
-- Then run: supabase/data.sql
--
-- WARNING: drops ALL app tables (orders, products, stories, journal, etc.)
-- =============================================================================
